...
class PostgresRepository:
    ...
    @staticmethod
    async def get_all_tasks(search: Optional[str] = None, done: Optional[bool] = None) -> list[TaskResponse]:
        pool = await get_pool()
    ...
    async def get_stats() -> dict:
        ...
        async with pool.acquire() as conn:
            ...
            done_count = await conn.fetchval("SELECT COUNT(*) FROM tasks WHERE done = TRUE")
